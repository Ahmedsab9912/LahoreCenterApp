...
class CategoryItemsSMScreen extends StatefulWidget {
  CompanyCategoryModel companyCategoryModel;
  CompanyModel companyModel;

  CategoryItemsSMScreen({
    required this.companyModel,
    required this.companyCategoryModel,
    Key? key,
  }) : super(key: key);

  @override
  State<CategoryItemsSMScreen> createState() => _CategoryItemsSMScreenState();
}

class _CategoryItemsSMScreenState extends State<CategoryItemsSMScreen> {
  var _width;
  var _height, empcod;
  ...
  Widget build(BuildContext context) {
    ...
    _height = MediaQuery.of(context).size.height * 0.95;
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.companyCategoryModel.tctgdsc.toString()),
      ),
      body: Column(
        children: [
          Padding(
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    onChanged: (action) => searchFunction(action),
  ...
  Future<List<ItemsModel>> getUserData() async {
    var response = await http.post(Uri.parse(companycategoryitem), body: {
      'PCmpCod': widget.companyModel.tcmpcod,
      'PCtgCod': widget.companyCategoryModel.tctgcod,
    });
  ...
  void searchFunction(String searchKey) {
    searchlistModel = companyCategoryModel
        .where((element) =>
        element.titmdsc.toString().contains(searchKey.toUpperCase()))
        .toList();
    setState(() {});
  }
