...
import 'CategoryCompanySMPage.dart';


class CategorySMScreen extends StatefulWidget {
  const CategorySMScreen({super.key});

  @override
  State<CategorySMScreen> createState() => _CategorySMScreenState();
}

class _CategorySMScreenState extends State<CategorySMScreen> {
                                  ...
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (BuildContext context) =>
                                              CategoryCompanySMPage(categoryModel: searchlistModel[index],)));
                                },
                                child: Card(
