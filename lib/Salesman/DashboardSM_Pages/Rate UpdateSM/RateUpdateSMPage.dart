...
class RateUpdateSMScreen extends StatefulWidget {
  const RateUpdateSMScreen({super.key});

  @override
  State<RateUpdateSMScreen> createState() => _RateUpdateSMScreenState();
}

class _RateUpdateSMScreenState extends State<RateUpdateSMScreen> {
            ...
            child: InkWell(
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Text(dateTimeFormat.toString(),style: TextStyle(color: Colors.red,fontSize: 17,fontWeight: FontWeight.bold),),
                ),
              ),
            ),
          ),
