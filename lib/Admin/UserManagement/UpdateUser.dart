...
class UpdateUserScreen extends StatefulWidget {
  ...
  UpdateUserScreen({ required this.allUsersModel, Key? key})
      : super(key: key);
...
class _UpdateUserScreenState extends State<UpdateUserScreen> {
  ...
  userDataImplement(){
    controller_userId.text = widget.allUsersModel.tusrid.toString();
    controller_userName.text = widget.allUsersModel.tusrid.toString();
    controller_userPassword.text = widget.allUsersModel.tusrpwd.toString();
    controller_userMobile.text = widget.allUsersModel.tmobnum.toString();
    controller_user_Email.text = widget.allUsersModel.temladd.toString();
    dropdown_uStatus = widget.allUsersModel.tusrsts.toString();
    dropDown_uType = widget.allUsersModel.tusrtyp.toString();
    controller_location_id.text = widget.allUsersModel.tloccod.toString();
    controller_salesman_code.text = widget.allUsersModel.tempcod.toString();
  }
  //USING POST METHOD TO EDIT THE USERS
  updateUser() async {
    var uri = await http.post(
        Uri.parse(update_user),
        body: {
          'id': widget.allUsersModel.id.toString(),
